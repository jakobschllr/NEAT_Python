...
class Species():
    ...
    def calculate_fitness(self, run_stat):
    ...
    def crossover_networks(self, gene_disabled_rate, hist_marker):
        ...
        input_neurons_amt = len(parent_1.input_neurons)
        output_neurons_amt = len(parent_1.output_neurons)

        crossover_network = Network(input_neurons_amt, output_neurons_amt)
        neurons = []
